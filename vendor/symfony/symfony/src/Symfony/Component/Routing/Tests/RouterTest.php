...
class RouterTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->router = new Router($this->loader, 'routingContactsEntreprise.yml');
    }
    ...
    public function testThatRouteCollectionIsLoaded()
    {
        ...
        $this->loader->expects($this->once())
            ->method('load')->with('routingContactsEntreprise.yml', 'ResourceType')
    ...
    public function testMatcherIsCreatedIfCacheIsNotConfigured($option)
    {
        ...
        $this->loader->expects($this->once())
            ->method('load')->with('routingContactsEntreprise.yml', null)
